...
if System_Curr >= 260: status = status + ' System-curr= ' + str(System_Curr); 
if Load_Curr >=200: status = status + ' Load-curr= ' + str(Load_Curr); 
if Batt_Curr >= 80: status = status + ' Batt-curr= ' + str(Batt_Curr); 
