...
if (AC_Alarm & 4):
        ...
        if (Alarm_Relay & 8) and (Alarm_Relay & 16) == 0 : # chi gpip 4, khong gpip5 
                        status = status + 'Relay AC - Error'
                        status_code = 1
        if (Alarm_Relay & 16) and (Alarm_Relay & 8) == 0: # chi GPIP5, khong GPIP4
        ...
        if (Alarm_Relay & 8) and (Alarm_Relay & 16) : #GPIP4 & GPIP5 
